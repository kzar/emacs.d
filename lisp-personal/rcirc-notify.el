...
;; Copyright (c) 2014 Dave Barker <kzar@kzar.co.uk>
;;
...
;;
;;;; Changelog:
;; * 2014/??/?? - Hacked by kzar to work with Mavericks notifications
;;                and to play a nice message sound.
...
(defun my-page-me (msg)
  (cond
    ...
    ((executable-find "growlnotify")
     (start-process "beep-process" nil "afplay" "/Applications/Skype.app/Contents/Resources/Sounds/Message Received .m4a")
     (start-process "page-me" nil "terminal-notifier" "-group" "Emacs" "-title" "Emacs" "-sender" "org.gnu.Emacs" "-activate" "org.gnu.Emacs" "-message" msg))
