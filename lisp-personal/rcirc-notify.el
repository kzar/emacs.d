...
;;                simplified loading of our rcirc hooks,
...
(defun rcirc-notify-page-me (msg)
  ...
  (cond
    ...
    ((executable-find "terminal-notifier")
     (start-process "page-me" "*debug*" "terminal-notifier" "-group" "Emacs" "-title" "rcirc" "-sender" "org.gnu.Emacs" "-activate" "org.gnu.Emacs" "-message" msg))
